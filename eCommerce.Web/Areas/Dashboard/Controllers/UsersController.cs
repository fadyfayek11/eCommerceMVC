            ...
            try
            {
                if (model != null)
                {
                    ...
                    if (user != null)
                    {
                        ...
                        var userCurrentStatus = user.isActive;
                        ...
                        if(result.Succeeded)
                        {
                            if (userCurrentStatus == !model.isActive && model.isActive == true)
                            {
                                await UserManager.SendEmailAsync(user.Id, EmailTextHelpers.AccountConfirmedEmailSubject(AppDataHelper.CurrentLanguage.ID), EmailTextHelpers.AccountConfirmedEmailBody(AppDataHelper.CurrentLanguage.ID));
                            }
