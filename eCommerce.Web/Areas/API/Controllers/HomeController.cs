            ...
            if(featuredProducts != null && featuredProducts.Count > 0)
            {
                ...
                foreach (var product in featuredProducts)
                {
                    ...
                    productsList.Add(new ProductEntity()
                    {
                        ...
                        ProductSpecifications = currentLanguageProductRecord.ProductSpecifications != null ? currentLanguageProductRecord.ProductSpecifications.Select(x => new ProductSpecificationEntity() { Title = x.FeatureValue.Feature.FeatureName, Value = x.FeatureValue.Value }).ToList() : new List<ProductSpecificationEntity>(),
