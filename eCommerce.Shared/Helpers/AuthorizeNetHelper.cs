    ...
    public static class AuthorizeNetHelper
    {
        ...
        public static AuthorizeNetResponse ExecutePayment(Order newOrder, creditCardType creditCardInfo)
        {
            ...
            try
            {
                ...
                {
                    lineItems[i] = new lineItemType { itemId = orderItem.ProductType.ProductID.ToString(), name = orderItem.ProductName.ToAuthorizeNetProductName(), quantity = orderItem.Quantity, unitPrice = orderItem.ItemPrice };
