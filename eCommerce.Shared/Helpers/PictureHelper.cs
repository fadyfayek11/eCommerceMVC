...
namespace eCommerce.Shared.Helpers
{
    ...
    {
        public static MvcHtmlString Picture(this HtmlHelper htmlHelper, Picture picture, string classes = "", string style = "",string width="", string alt = "", string defaultPic = eCommerceConstants.DEFAULT_PICTURE, bool lazyLoad = true)
        {
